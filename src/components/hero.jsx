...
function Hero() {
  return (
    <>
      <div className="w-full h-[100svh] md:h-screen flex items-center justify-center relative">
        ...
        <div className="absolute top-0 left-0 w-full h-full bg-black/50 flex flex-col justify-center items-center text-arifin-100 text-center font-raleway px-6 md:px-12 lg:px-14 xl:px-28 ">
          ...
          <a href="#category" className="absolute w-full bottom-10 left-0 right-0">
            <FontAwesomeIcon icon={faChevronCircleDown} className="text-3xl md:text-4xl animate-bounce"/>
          </a>
        </div>
